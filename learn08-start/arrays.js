function start() {
  ...
  languages.sort();
  document.getElementById("sorted").innerHTML = languages.toString();
  languages.reverse();
  document.getElementById("reversed").innerHTML = languages.toString();
  ...
  document.getElementById("num-sorted").innerHTML = numbers.toString();
